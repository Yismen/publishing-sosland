...
class DispositionResource extends Resource
{
        ...
        return $form
            ->schema([
                Forms\Components\TextInput::make('name')
                    ->required()
                    ->unique(Disposition::class, ignoreRecord: true)
                    ->maxLength(255),
                Forms\Components\Toggle::make('is_mailable')
                    ->required()
                    ->default(true),
            ]);
    }
        ...
        return $table
            ->columns([
                Tables\Columns\TextColumn::make('name')
                    ->searchable(),
                Tables\Columns\IconColumn::make('is_mailable')
                    ->boolean(),
    ...
    {
        return [
            'index' => Pages\ManageDispositions::route('/'),
        ];
    }
}
